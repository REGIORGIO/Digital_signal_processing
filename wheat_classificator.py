from classificatorGLCM_NN import convert_images_to_params, get_accuracy
...
if __name__ == "__main__":
    ...
    convert_images_to_params(root_folder + 'train/', input_train_params)
    convert_images_to_params(root_folder + 'test/', input_test_params)
